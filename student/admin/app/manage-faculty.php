...
<?php require("requried/header.php");?>
  ...
  <main id="main" class="main">
    ...
    <div class="row">
          ...
          <div class="form-group">
            <div class="col-sm-12">
              ...
              <br>
                ...
                <div class="col-sm-12">
                <button type="button" class="btn btn-success" onclick='add_update_faculty()'>Add / Update</button>
      ...
      <div class="col-lg-8">
      <h4><i class="fa fa-edit"></i>Selected Faculty</h4>
